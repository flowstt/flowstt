...
Provides system tray (notification area) integration for the FlowSTT application on Windows.
...
The tray icon SHALL display a context menu when right-clicked, containing Show, About, and Exit items.

#### Scenario: Right-click shows context menu
- **WHEN** the user right-clicks the tray icon
- **THEN** a context menu appears immediately
- **AND** the menu contains "Show", "About", and "Exit" items
